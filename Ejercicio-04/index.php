...
<main class="container d-flex align-items-center justify-content-center text-white">
  ...
  <form class="bg-black col-6 d-flex flex-column align-items-center justify-content-center p-4 gap-3 border border-light-subtle rounded shadow" action="./php/inicio.php" method="POST">
    <header>
